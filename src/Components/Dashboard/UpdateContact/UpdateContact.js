    ...
    return(
        <section className={Classes.containerForm}>
				...
				<form onSubmit={this.update}>
					<label>Name</label>
					<input type="text" name="name" placeholder="Enter Name" value={this.state.name}  onChange={this.changeInput} />
					<label>Email</label>
					<input type="text" name="email" placeholder="Enter Email" value={this.state.email} onChange={this.changeInput}/>
